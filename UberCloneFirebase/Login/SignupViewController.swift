...
class SignupViewController : UIViewController {
    ...
    lazy var logInText: UIButton = {
        ...
        attributedText.append(NSAttributedString(string: "Log In", attributes: [NSAttributedString.Key.foregroundColor : UIColor.systemBlue, NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 20)]))
